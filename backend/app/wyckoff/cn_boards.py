"""A-share board helpers imported from WyckoffTradingAgent.

Source: reference/WyckoffTradingAgent/WyckoffTradingAgent-main/core/cn_boards.py
License: AGPL-3.0-only. Local-only integration; reassess before distribution.
"""
