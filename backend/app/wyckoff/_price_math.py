"""Shared price/volume helpers imported from WyckoffTradingAgent.

Source: reference/WyckoffTradingAgent/WyckoffTradingAgent-main/core/_price_math.py
License: AGPL-3.0-only. This local-only integration retains the upstream source
attribution; do not distribute this file without reassessing the license.
"""
